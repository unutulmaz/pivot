...
define("d3-sankey", function(){});

(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define('d3-cloud',[],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g=(g.d3||(g.d3 = {}));g=(g.layout||(g.layout = {}));g.cloud = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
...
(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('src/common/Class',[], factory);
    } else {
...
(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('src/common/Platform',["d3", "es6-promise"], factory);
    } else {
...
(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('src/common/PropertyExt',["./Class"], factory);
    } else {
...
(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('src/common/Utility',["d3", "require", "es6-promise"], factory);
    } else {
...
(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('src/common/Database',["d3", "./Class", "./PropertyExt", "./Utility"], factory);
    } else {
...
(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('src/common/Widget',["d3", "./Class", "./Platform", "./PropertyExt", "./Database"], factory);
    } else {
...
(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('src/common/CanvasWidget',["d3", "./Widget"], factory);
    } else {
...
(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('src/common/Transition',[], factory);
    } else {
...
(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('src/common/SVGWidget',["d3", "./Widget", "./Transition"], factory);
    } else {
...
define('css!src/common/Text',[],function(){});

(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('src/common/Text',["./SVGWidget", "css!./Text"], factory);
    } else {
...
define('css!src/common/FAChar',[],function(){});

(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('src/common/FAChar',["./SVGWidget", "./Text", "css!font-awesome", "css!./FAChar"], factory);
    } else {
...
(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('src/common/HTMLWidget',["d3", "./Widget", "./Transition"], factory);
    } else {
...
define('css!src/common/Shape',[],function(){});

(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('src/common/Shape',["d3", "./SVGWidget", "css!./Shape"], factory);
    } else {
...
define('css!src/common/Icon',[],function(){});

(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('src/common/Icon',["./SVGWidget", "./Shape", "./FAChar", "css!./Icon"], factory);
    } else {
...
(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('src/common/IList',[], factory);
    } else {
...
(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('src/common/Image',["./HTMLWidget"], factory);
    } else {
...
(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('src/common/IMenu',[], factory);
    } else {
...
define('css!src/common/TextBox',[],function(){});

(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('src/common/TextBox',["./SVGWidget", "./Shape", "./Text", "css!./TextBox"], factory);
    } else {
...
define('css!src/common/List',[],function(){});

(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('src/common/List',["d3", "../common/SVGWidget", "./IList", "../common/TextBox", "css!./List"], factory);
    } else {
...
define('css!src/common/Menu',[],function(){});

(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('src/common/Menu',["d3", "./SVGWidget", "./IMenu", "./Icon", "./List", "css!./Menu"], factory);
    } else {
...
(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('src/common/Palette',["d3", "colorbrewer"], factory);
    } else {
...
define('css!src/common/Surface',[],function(){});

(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('src/common/Surface',["d3", "./SVGWidget", "./Icon", "./Shape", "./Text", "./FAChar", "./Menu", "css!./Surface"], factory);
    } else {
...
define('css!src/common/ResizeSurface',[],function(){});

(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('src/common/ResizeSurface',["d3", "./Surface", "css!./ResizeSurface"], factory);
    } else {
...
define('css!src/common/SVGZoomWidget',[],function(){});

(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('src/common/SVGZoomWidget',["d3", "../common/SVGWidget", "../common/Icon", "css!./SVGZoomWidget"], factory);
    } else {
...
(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('src/common/WidgetArray',["./Widget"], factory);
    } else {
