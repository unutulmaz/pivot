...
define('css!src/chart/Axis',[],function(){});

(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('src/chart/Axis',["d3", "../common/SVGWidget", "../common/Utility", "css!./Axis"], factory);
    } else {
...
define('css!src/chart/XYAxis',[],function(){});

(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('src/chart/XYAxis',["d3", "../common/SVGWidget", "./Axis", "../common/Utility", "css!./XYAxis"], factory);
    } else {
...
define('css!src/chart/Scatter',[],function(){});

(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('src/chart/Scatter',["d3", "../common/SVGWidget", "./XYAxis", "../api/INDChart", "../api/ITooltip", "css!./Scatter"], factory);
    } else {
...
(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('src/chart/Area',["d3", "./Scatter"], factory);
    } else {
...
define('css!src/chart/Column',[],function(){});

(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('src/chart/Column',["d3", "./XYAxis", "../api/INDChart", "../api/ITooltip", "css!./Column"], factory);
    } else {
...
(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('src/chart/Bar',["./Column"], factory);
    } else {
...
define('css!src/chart/Bubble',[],function(){});

(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('src/chart/Bubble',["d3", "../common/SVGWidget", "../api/I2DChart", "../common/Text", "../common/FAChar", "../common/Utility", "../api/ITooltip", "css!./Bubble"], factory);
    } else {
...
define('css!src/chart/Bullet',[],function(){});

(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('src/chart/Bullet',["d3", "../common/HTMLWidget", "../common/Utility", "d3-bullet", "css!./Bullet"], factory);
    } else {
...
(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('src/chart/Gantt',["./Bar"], factory);
    } else {
...
define('css!src/chart/HexBin',[],function(){});

(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('src/chart/HexBin',["d3", "../common/SVGWidget", "./XYAxis", "../api/INDChart", "../api/ITooltip", "../common/Palette", "d3-hexbin", "css!./HexBin"], factory);
    } else {
...
define('css!src/chart/Line',[],function(){});

(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('src/chart/Line',["d3", "./Scatter", "css!./Line"], factory);
    } else {
...
(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('src/chart/MultiChart',["d3", "../common/HTMLWidget", "../common/Utility", "../api/INDChart"], factory);
    } else {
...
(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('src/chart/MultiChartSurface',["d3", "../common/ResizeSurface", "./MultiChart", "../api/INDChart"], factory);
    } else {
...
define('css!src/chart/Pie',[],function(){});

(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('src/chart/Pie',["d3", "../common/SVGWidget", "../api/I2DChart", "../common/Text", "../common/FAChar", "../common/Utility", "../api/ITooltip", "css!./Pie"], factory);
    } else {
...
(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('src/chart/Step',["d3", "./Scatter"], factory);
    } else {
...
define('css!src/chart/Summary',[],function(){});

(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('src/chart/Summary',["d3", "../common/HTMLWidget", "../api/I2DChart", "css!font-awesome", "css!./Summary"], factory);
    } else {
