...
(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('src/composite/MegaChart',["../layout/Border", "../chart/MultiChart", "../common/Text", "../other/Legend", "../layout/Toolbar", "../form/Select", "../form/Button", "../form/Input", "../common/Utility"], factory);
    } else {
