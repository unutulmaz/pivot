...
(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('src/marshaller/FlyoutButton',["../form/Button", "../layout/Popup", "../layout/Surface"], factory);
    } else {
...
(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('src/marshaller/HipieDDL',["d3", "../common/Class", "../common/Database", "../common/Utility", "../other/Comms", "../common/Widget", "../composite/MegaChart", "../chart/MultiChart", "../other/Table", "require", "es6-promise"], factory);
    } else {
...
(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('src/marshaller/HipieDDLMixin',["d3", "../common/Class", "../common/PropertyExt", "../common/Utility", "./HipieDDL", "../other/Persist", "../layout/Surface", "./FlyoutButton"], factory);
    } else {
...
(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('src/marshaller/Graph',["d3", "../common/SVGWidget", "../common/TextBox", "../common/Surface", "../common/ResizeSurface", "../chart/MultiChartSurface", "../common/Palette", "../graph/Graph", "../graph/Vertex", "../graph/Edge", "./HipieDDLMixin"], factory);
    } else {
...
(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('src/marshaller/HTML',["d3", "../layout/Grid", "./HipieDDLMixin"], factory);
    } else {
...
(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('src/marshaller/Tabbed',["d3", "../layout/Tabbed", "../layout/Grid", "./HipieDDL", "../layout/Surface", "../layout/Cell"], factory);
    } else {
...
(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('src/marshaller/TargetMarshaller',["d3", "../common/HTMLWidget", "./HipieDDLMixin"], factory);
    } else {
...
define("hpcc-viz-marshaller", function(){});
