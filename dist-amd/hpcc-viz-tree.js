...
define('css!src/tree/CirclePacking',[],function(){});

(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('src/tree/CirclePacking',["d3", "../common/SVGWidget", "../api/ITree", "../common/Text", "../common/FAChar", "css!./CirclePacking"], factory);
    } else {
...
define('css!src/tree/Dendrogram',[],function(){});

(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('src/tree/Dendrogram',["d3", "../common/SVGZoomWidget", "../common/PropertyExt", "../api/ITree", "../common/Utility", "css!./Dendrogram"], factory);
    } else {
...
define('css!src/tree/SunburstPartition',[],function(){});

(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('src/tree/SunburstPartition',["d3", "../common/SVGWidget", "../api/ITree", "../common/Text", "../common/FAChar", "css!./SunburstPartition"], factory);
    } else {
...
define('css!src/tree/Treemap',[],function(){});

(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('src/tree/Treemap',["d3", "../common/HTMLWidget", "../common/PropertyExt", "../api/ITree", "../common/Utility", "css!./Treemap"], factory);
    } else {
...
('.tree_CirclePacking circle{fill:#1f77b4;fill-opacity:.25;stroke:#1f77b4;stroke-width:1px}.tree_CirclePacking .leaf circle{fill:#ff7f0e;fill-opacity:1}.tree_CirclePacking .label{fill:#fff;text-anchor:middle}.tree_Dendrogram .node circle{fill:#dcf1ff;stroke:#1f77b4;stroke-width:1px}.tree_Dendrogram .node.selected circle,.tree_Dendrogram .node.selected.over circle{stroke:red}.tree_Dendrogram .node.over circle{stroke:orange}.tree_Dendrogram .node.selected text,.tree_Dendrogram .node.selected.over text{fill:red}.tree_Dendrogram .node.over text{fill:orange}.tree_Dendrogram .node text{font-size:14px}.tree_Dendrogram .link{fill:none;stroke:#656565;stroke-width:1px}.tree_Sunburst path{stroke:#fff;stroke-width:.5px;fill-rule:evenodd}.tree_Treemap .node{border:solid 1px #fff;overflow:hidden;text-overflow:ellipsis;position:absolute;text-indent:2px}.tree_Treemap .node.selected,.tree_Treemap .node.selected.over{border-color:red}.tree_Treemap .node.over{border-color:orange}');

define("hpcc-viz-tree", function(){});
